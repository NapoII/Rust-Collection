function calculate_fert() {
    ...
    const inputValue_bone = parseFloat(document.getElementById("inputValue_bone").value);

    // calc
    const fert_from_bone = inputValue_bone * 0.25
    const fert_from_dung = inputValue_dung * 10;
    const fert = fert_from_dung + inputValue_fert + fert_from_bone;
